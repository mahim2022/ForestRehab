...
const tiers = [
  ...
  },
  {
    ...
    description: [
      ...
      "Personalized conservation plans",
    ...
    >
      ...
      >
        ...
        <Typography variant="body1" sx={{ color: "text.secondary" }}>
          Choose a plan that suits your involvement in forest conservation. Each
          plan offers unique features to help you contribute effectively.
        </Typography>
      </Box>
      <Grid
        container
